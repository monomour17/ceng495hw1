            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 mb-8">
                    <div className="flex items-center gap-5 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">Regular User</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-zinc-50 dark:bg-zinc-800 rounded-xl p-4 text-center">
                            ...
                            <p className="text-sm text-zinc-500 mt-1">Average Rating: <span className="font-bold text-zinc-700 dark:text-zinc-300">{user.averageRating || 0} / 5</span></p>
                        </div>
                        <div className="bg-zinc-50 dark:bg-zinc-800 rounded-xl p-4 text-center">
                            <p className="text-3xl font-black text-blue-500">{(user.reviews || []).length}</p>
                            <p className="text-sm text-zinc-500 mt-1">Total Reviews</p>
                        </div>
                    </div>
                </div>
                ...
                {(user.givenRatings || []).length > 0 && (
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 mb-6">
                        <h2 className="text-lg font-bold mb-4">⭐ My Ratings ({user.givenRatings.length})</h2>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
                    <h2 className="text-lg font-bold mb-4">💬 My Reviews ({(user.reviews || []).length})</h2>
