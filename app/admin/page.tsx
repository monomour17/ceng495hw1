            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
                            <h2 className="text-xl font-bold mb-4">🗑️ Delete Product ({items.length})</h2>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        {/* Existing users list */}
                        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
                            <h2 className="text-xl font-bold mb-4">🗑️ Delete User ({users.length})</h2>
                            <div className="flex flex-col gap-2 max-h-80 overflow-y-auto pr-1">
                                {users.map((u) => (
                                    <div key={u._id.toString()} className="flex items-center justify-between gap-3 border border-zinc-100 dark:border-zinc-800 rounded-xl px-4 py-3">
                                        ...
                                        {u.role === "admin" && (
                                            <span className="text-xs text-zinc-400 italic">Cannot delete</span>
                                        )}
                                    </div>
                                ))}
                            </div>
